                ...
                <div class="card-content collpase collapse show" style="">
                    <div class="card-body">
                        <div class="col-xs-12 col-md-12 table-responsive">
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <a href="{{ route('admin.users.create') }}" class="btn btn-success btn-block btn-lg"
                            ...
                            <table class="table table-hover mb-0 display dataTable responsive nowrap"
                                data-route="{{ route('admin.users.anyData') }}" id="user-table" width="100%">
                                <thead>
                                    <tr>
                                        <th></th>
...
*****************************/--}}
@section('jscontent')
    <script src="{{ asset('js/form-js/user.js') }}" type="text/javascript"></script>
